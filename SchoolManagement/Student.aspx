<%@ Page Title="Student" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="SchoolManagement.Student" %>
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li>
                    <a runat="server" href="~/Student">Student</a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="Email" ErrorMessage="Invalid Email Format"></asp:RegularExpressionValidator>
                            </div>
                        </div>
                    </div>
                    <div class="row">
